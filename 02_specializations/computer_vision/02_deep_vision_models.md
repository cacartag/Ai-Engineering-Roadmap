# 🎯 Deep Learning Vision Models (ResNet, EfficientNet)

> Dedicated Focus & Study Guide for 06. Computer Vision

## 📖 Overview
Understand deep residual connections, feature extraction, and pre-trained classification backbones.

## 🎯 Learning Objectives
- Gain deep conceptual mastery of Deep Learning Vision Models (ResNet, EfficientNet).
