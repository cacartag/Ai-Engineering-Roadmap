# 🎯 Quantization, GGUF & Local Execution (Ollama / vLLM)

> Dedicated Focus & Study Guide for 08. Large Language Models

## 📖 Overview
Understand 4-bit / 8-bit quantization (AWQ, GPTQ, GGUF) and run high-performance local inference engines.

## 🎯 Learning Objectives
- Gain deep conceptual mastery of Quantization, GGUF & Local Execution (Ollama / vLLM).
