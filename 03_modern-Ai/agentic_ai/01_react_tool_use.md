...
- [ ] **Requirement 2 (+50 XP)**: Master OpenAI Function Calling & JSON Schema tool definition
- [ ] **Requirement 3 (+50 XP)**: Implement Thought-Action-Observation loop execution parser
- [ ] **Requirement 4 (+50 XP)**: Mini-Project: Build a Python ReAct Agent with Web Search & Calculator tools
...
- Master all theoretical principles and practical code patterns for ReAct Pattern & Tool-Use Execution.
